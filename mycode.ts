...
twitLink.appendChild(twitPic)
instaLink.appendChild(instaPic)
tokLink.appendChild(tokPic)
pintLink.appendChild(pintPic)
faceLink.appendChild(facePic)
iArea8?.appendChild(twitLink)
iArea8?.appendChild(instaLink)
iArea8?.appendChild(tokLink)
iArea8?.appendChild(pintLink)
iArea8?.appendChild(faceLink)
// End Area 8